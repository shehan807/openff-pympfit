...
100,000 drug-like molecules from the ZINC database [@irwin_zinc_2012]. Moreover, `pympfit` is being used to extend CrystaLattE [@parmar_shehan807crystalatte_2025] to enable rapid crystal lattice energy predictions using molecular mechanics tooling.
